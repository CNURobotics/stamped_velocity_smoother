/**
 * @file /include/stamped_velocity_smoother/velocity_smoother_nodelet.hpp
 *
...
#ifndef STAMPED_VELOCITY_SMOOTHER_HPP_
#define STAMPED_VELOCITY_SMOOTHER_HPP_
...
private:
  ...
  geometry_msgs::TwistStamped           last_target_vel_msg;
  ...
  void twistStampedCB(const geometry_msgs::TwistStamped::ConstPtr& msg);
  void velocityTarget(const geometry_msgs::Twist& msg);

  void robotVelCB(const geometry_msgs::TwistStamped::ConstPtr& msg);
  ...
  ** Dynamic Reconfigure
  **********************/
  dynamic_reconfigure::Server<stamped_velocity_smoother::paramsConfig> *             dynamic_reconfigure_server;
  dynamic_reconfigure::Server<stamped_velocity_smoother::paramsConfig>::CallbackType dynamic_reconfigure_callback;
  void reconfigCB(stamped_velocity_smoother::paramsConfig &config, uint32_t unused_level);
};

} // stamped_namespace velocity_smoother

#endif /* STAMPED_VELOCITY_SMOOTHER_HPP_ */
